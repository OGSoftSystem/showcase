    ...
    <>
        ...
        <Wrapper>
          ...
          <div className="w-full h-auto flex justify-center">
            <p className="p-text max-w-4xl md:text-center ">
              ...
              transaction speeds and lower gas fees. pLUSD holders benefit from enhanced 
              liquidity and financial operations on the blockchain. The project aligns with the
              vision of Richard Heart, the founder of PulseChain, emphasizing technological
              innovation and practical utility. pLUSD is integral to advancing the ecosystem&apos;s
              goal of improving scalability and user experience, facilitating a more efficient
      ...
      <section className="relative w-full my-20 bg-grad-2/15 py-20">
        ...
        <Wrapper className="grid grid-col-1 md:grid-cols-2 lg:grid-cols-3 gap-16">
          {NOTES.map((note) => (
            <div key={note.title} className="z-10 space-y-4 flex flex-col h-auto items-center">
                <h1 className="mb-4 text-accent-foreground font-semibold text-2xl">
                  {note.title}
                </h1>
                <div className="min-h-40">

              <p className="p-text font-light">
                {note.text}
              </p>
                </div>
